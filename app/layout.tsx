...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "Waaw CRM",
    "Waaw POS",
    "Waaw Inventory Management",
    "Waaw School Management",
    "Waaw Clinic Management",
    "Waaw Restaurant Management",
    "Waaw E-commerce",
    "Waaw Website",
    "Waaw Digital Marketing",
    "Waaw SEO",
    "Waaw SMM",
    "Waaw Content Writing",
    "Waaw Logo Design",
    "Waaw UI/UX Design",
    "Waaw Mobile App Development",
    "Waaw Web App Development",
    "Waaw Custom Software Development",
    "Waaw Technology Solutions",
  ],
